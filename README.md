...
### Recent Updates
- **v2.2.3** (Feb 25, 2026) - Phase 3 Enhanced Booking Form with Ghost Inventory
...
- Color-coded by status (Today, Weekend, Booked, Available)
...
- Role-based access control:
  ...
  - **Room Boss**: Pending approvals, notifications
  - **IT Staff**: Device assignment queue
  - **Staff**: Create bookings (goes to pending)
...
- **Database**: PostgreSQL 14+ with exclusion constraints
...
- `devices` - IT equipment inventory
- `device_categories` - Laptop, Desktop, etc.
...
├── migrations/
│   ├── v2.2_add_tenancy.sql      # Multi-tenancy migration
...
├── HANDOVER_v2.2.md             # Technical handover document
├── README.md                     # This file
...
| Role | Menu Access | Special Features |
|------|-------------|------------------|
| **Admin** | Dashboard, Notifications, Calendar, Device Queue, Bookings, Approvals, Inventory | Direct room booking, conflict override |
| **Room Boss** | Dashboard, Notifications, Calendar, Bookings, Pricing, Pending Approvals, Inventory | Assign rooms to pending bookings |
| **IT Staff** | Calendar, Device Assignment Queue | Device assignment, off-site tracking |
| **Staff** | Calendar, Bookings, Pricing, Approvals, Inventory | Create bookings (goes to pending) |
...
|----------|-------------|
| [HANDOVER_v2.2.md](HANDOVER_v2.2.md) | Technical handover from v2.1.1 to v2.2.0 |
| [CHANGELOG.md](CHANGELOG.md) | Version history and release notes |
| [ARCHITECTURE.md](ARCHITECTURE.md) | Detailed system architecture |
| [API.md](API.md) | API documentation for service layer |
